...
import {
  ConvexHttpClient
} from "./chunk-IOMKOVN7.js";
import "./chunk-VJDZZ2HR.js";
import {
  require_react
} from "./chunk-T7TOT62Q.js";
import {
  __commonJS,
  __toESM
...
var ConvexAuthActionsContext = (0, import_react8.createContext)(void 0);
var ConvexAuthInternalContext = (0, import_react8.createContext)(void 0);
function useAuth() {
  return (0, import_react8.useContext)(ConvexAuthInternalContext);
}
var ConvexAuthTokenContext = (0, import_react8.createContext)(null);
...
function AuthProvider({ client, serverState, onChange, storage, storageNamespace, replaceURL, children }) {
  const token = (0, import_react8.useRef)((serverState == null ? void 0 : serverState._state.token) ?? null);
  const [isLoading, setIsLoading] = (0, import_react8.useState)(token.current === null);
  const [tokenState, setTokenState] = (0, import_react8.useState)(token.current);
  const verbose = client.verbose ?? false;
  const logVerbose = (0, import_react8.useCallback)((message) => {
    var _a;
    if (verbose) {
  ...
  const [isRefreshingToken, setIsRefreshingToken] = (0, import_react8.useState)(false);
  const setToken = (0, import_react8.useCallback)(async (args) => {
  ...
  const verifyCode = (0, import_react8.useCallback)(async (args) => {
    let lastError;
    let retry = 0;
  ...
  const verifyCodeAndSetToken = (0, import_react8.useCallback)(async (args) => {
  ...
  const signIn = (0, import_react8.useCallback)(async (provider, args) => {
  ...
  const signOut = (0, import_react8.useCallback)(async () => {
    try {
  ...
  const fetchAccessToken = (0, import_react8.useCallback)(async ({ forceRefreshToken }) => {
  ...
  const signingInWithCodeFromURL = (0, import_react8.useRef)(false);
  (0, import_react8.useEffect)(
    () => {
      if (storage === void 0) {
  ...
  const actions = (0, import_react8.useMemo)(() => ({ signIn, signOut }), [signIn, signOut]);
  const isAuthenticated = tokenState !== null;
  const authState = (0, import_react8.useMemo)(() => ({
    isLoading,
    isAuthenticated,
    fetchAccessToken
...
function useNamespacedStorage(peristentStorage, namespace) {
  ...
  const storage = (0, import_react8.useMemo)(() => peristentStorage ?? inMemoryStorage(), [peristentStorage]);
  const escapedNamespace = namespace.replace(/[^a-zA-Z0-9]/g, "");
  const storageKey = (0, import_react8.useCallback)((key) => `${key}_${escapedNamespace}`, [namespace]);
  const storageSet = (0, import_react8.useCallback)((key, value) => storage.setItem(storageKey(key), value), [storage, storageKey]);
  const storageGet = (0, import_react8.useCallback)((key) => storage.getItem(storageKey(key)), [storage, storageKey]);
  const storageRemove = (0, import_react8.useCallback)((key) => storage.removeItem(storageKey(key)), [storage, storageKey]);
  return { storageSet, storageGet, storageRemove, storageKey };
}
function useInMemoryStorage() {
  const [inMemoryStorage, setInMemoryStorage] = (0, import_react8.useState)({});
  return () => ({
...
function useAuthActions() {
  return (0, import_react10.useContext)(ConvexAuthActionsContext);
}
function ConvexAuthProvider(props) {
  const { client, storage, storageNamespace, replaceURL, children } = props;
  const authClient = (0, import_react10.useMemo)(() => {
    var _a;
    return {
...
function useAuthToken() {
  return (0, import_react10.useContext)(ConvexAuthTokenContext);
}
export {
  ConvexAuthProvider,
  useAuthActions,
